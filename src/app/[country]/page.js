...
// import styles from './[region]/[destination]/destination.module.css';
...
//     setLinks([{ title: name, href: `/${name?.replaceAll(' ', '-')}` }]);
//     return () => {
//       setLinks([]);
//     };
...
//           <DestinationHotels
//             destination='country'
//             destinationName={params?.country?.replaceAll('-', ' ')}
//           />
//         </div>
//       </div>
//     </div>
